...
#ifndef __INFOTOHTML_H_
#define __INFOTOHTML_H_
...
extern void infoInitializeRegexes
    (void);
    

extern void InfoToHTML
    (FILE          *stream,
...
extern char* EncodeInfoNodeName
    (const char  *pStr,
     int          length);


extern char* DecodeInfoNodeName
    (const char  *pStr,
     int          length);
